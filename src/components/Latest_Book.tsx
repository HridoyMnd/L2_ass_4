...
import { useDeleteBookMutation, useLatest_booksQuery } from "../Redux/Api/baseapi";
...
const Latest_Book = () => {
  const { data, isLoading } = useLatest_booksQuery(undefined);
  ...
  return (
    <div className="mt-10">
        <h2 className="text-center font-bold text-2xl">All Latest Book</h2>
